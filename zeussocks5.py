# zeussocks5.py
# ══════════════════════════════════════════════════════════════════════════════
# پروکسی SOCKS5 اختصاصی برای پنل «Zeus» — با قابلیت‌های:
#   ۱) محدودیت حجم (traffic_limit_gb)
#   ۲) انقضای روزانه (expires_days)
#   ۳) نمایش و محدودسازی اتصالات همزمان per IP
#   ۴) حذف پروکسی همراه با TCP Proxy عمومی
#   ۵) توکن مشترک با Bot TCP Proxy
# ══════════════════════════════════════════════════════════════════════════════
